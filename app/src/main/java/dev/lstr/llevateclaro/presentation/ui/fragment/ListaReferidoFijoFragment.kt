 ...
 */
class ListaReferidoFijoFragment : BaseFragment() {
    ...
    fun init(){
        ...
        listaReferidoViewModel.apply {
            messageLiveData.observe(this@ListaReferidoFijoFragment, Observer { message -> showErrorMessage(message!!) })
            listaReferidoLiveData.observe(this@ListaReferidoFijoFragment, Observer { data -> showData(data!!) })
        }
    ...
    fun loadData(){
        listaReferidoViewModel.getListaReferido("lrf")
    }
